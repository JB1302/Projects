...
namespace SGPT.Controllers
{
    public class ProyectoesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "idProyecto,Nombre,Descripcion,FechaInicio,FechaFin,Estado,Responsable")] Proyecto proyecto)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "idProyecto,Nombre,Descripcion,FechaInicio,FechaFin,Estado,Responsable")] Proyecto proyecto)
        {
            if (ModelState.IsValid)
            {
